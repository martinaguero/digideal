...
import org.trimatek.digideal.web.ContractWebSetup;
...
public class ContractServlet extends XtextServlet {
  ...
  public void init() {
    try {
      super.init();
      final Injector injector = new ContractWebSetup().createInjectorAndDoEMFRegistration();
