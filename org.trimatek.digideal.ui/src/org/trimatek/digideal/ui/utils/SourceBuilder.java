...
public class SourceBuilder {
	...
	static public String getDraft(ContractView view) {
		...
		sb.append(Tools.msg.getString("contract_identified_by_collector") + Config.COMMA_SYMBOL + " "
				+ view.getNickCollector() + " {" + view.getAddressCollector() + ", " + view.getEmailCollector() + "}" + "</b>"
				+ "<br/>");
		...
		sb.append(Tools.msg.getString("contract_the_sum") + " " + view.getSelectedCurrency() + " "
				+ view.getQuantity() + " " + Tools.msg.getString("contract_with") +  " BTC " + view.getBtc() + " <br/>");
