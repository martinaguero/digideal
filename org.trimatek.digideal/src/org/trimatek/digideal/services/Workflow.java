...
import org.trimatek.digideal.states.Received;
...
public class Workflow {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*
			 * State newState = new New(cnt); newState.run();
			 * System.out.println("MultisigAddress: " +
			 * newState.getContract().getMultisigAddress());
			 * System.out.println("RedeemScript: " +
			 * newState.getContract().getRedeemScript());
			 */
			...
			cnt.setUnspentTxId("375a11b8cbe9118d000154146b632149b987060b9a61e90e1dbd9a5791feee53");
			/*
			 ...
			 */
			cnt.setSts(new BigDecimal(1));
			cnt.setUnspentVout(0);
			cnt.setUnspentOutputScript("a91438a7e73d7d714e62e485b411b1d207291d02c69487");
			cnt.pushPayTx(new Transaction("","SINFIRMAR"));
			cnt.pushPayTx(new Transaction("","PARTIALLYSIGNED"));
			...
			State received = new Received(cnt);
			received.run();
			System.out.println("SignedPayTxRaw" + received.getContract().getpayTx().getRaw());
